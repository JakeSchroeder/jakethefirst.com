...
const Sidebar = styled.aside`
  ...
  transform: translateX(${({ isOpen }) => (isOpen ? `-220px` : `0`)});
    ...
    <Nav>
      <NavWrapper>
        <NavList>
          ...
          <NavItem>
            <ResumeDownload href={Resume} target={"_blank"}>
              Resume
            </ResumeDownload>
          </NavItem>
          <NavItem>
            <StyledLink activeClassName="active" to={"/education/"}>
              Education
            </StyledLink>
          </NavItem>
        ...
        <Social>
          <SocialLink
            href={
              "https://bitbucket.org/%7B78c8aadb-c136-4a0d-974a-6bbdd7f792fa%7D/"
            }
            rel={"nofollow"}
            target={"_blank"}
          >
