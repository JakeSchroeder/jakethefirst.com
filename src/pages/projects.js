...
const ProjectsPage = ({data, className}) => (
  <Fragment>
    <Seo title="Projects" />
      <WorkItem img={<StyledBackgroundSection  Tag="div" className={className} fluid={data.terrainScreen.childImageSharp.fluid} backgroundColor={`#040e18`}/>}  title={"Terrain Generator"}  description={"An audio visualization using the Perlin Noise algorithm to generate a 3d terrain. It is then offset by the waveform of a song called Timestretch by the dubstep artist Bassnectar. I have always been passionate about music and making sound interactive, I saw this as an opportunity to combine both and make something truly stunning."} link={"https://terrain-generator.netlify.com"} tags={"p5, Netlify"}/>
      <WorkItem isReversed img={<StyledBackgroundSection  Tag="div" className={className} fluid={data.isophexScreen.childImageSharp.fluid} backgroundColor={`#040e18`}/>}  title={"Isophex Solutions"}  description={"I created Isophex to be an affordable web development practice delivering custom web solutions. I designed this site to feel clean and professional with an emphasis on successful client case studies. I utilized the Zurb Foundation UI framework for the Frontend and deployed to Netlify for the hosting."} link={"https://isophex.com"} tags={"Foundation, Netlify"}/>
      <WorkItem img={<StyledBackgroundSection Tag="div" className={className} fluid={data.heliosScreen.childImageSharp.fluid} backgroundColor={`#040e18`}/>} title={"Helios IP"}  border description={"Helios Intellectual Property is a services technologies company that specializes in IP management. I designed this site to feel disruptive and cutting edge, more like a software company than a legal services company. I developed the site using plain old vanilla html, css, and js. It is hosted on Netlify."} link={"https://heliosipm.com"} tags={"Vanilla, Netlify"}/>
      <WorkItem isReversed  img={<StyledBackgroundSection  Tag="div" className={className} fluid={data.insightsScreen.childImageSharp.fluid} backgroundColor={`#040e18`}/>}  title={"Helios Insights"}  description={"Access featured articles, download industry research or browse a support knowledge base. I designed the site to feel responsive, reactive and easy to use. The Frontend is developed using Gatsby, a React framework. Authentication is handled by GoTrue API in combination with Netlify for hosting."} link={"https://heliosinsights.netlify.com"} tags={"Gatsby, Netlify"}/>
      <WorkItem img={<StyledBackgroundSection  Tag="div" className={className} fluid={data.dmsScreen.childImageSharp.fluid} backgroundColor={`#040e18`}/>} project={"Development"} border title={"Digital Marketing School"}  description={"A learning platform for people interested in becoming an expert in SEO, marketing and content creation. I collaborated with other developers on the Frontend, modifying WordPress templates with custom CSS and PHP. The entire solution is hosted on WPEngine."} link={"https://digitalmarketing.school"} tags={"Wordpress, WP Engine"}/>
      <WorkItem isReversed img={<StyledBackgroundSection  Tag="div" className={className} fluid={data.onestopScreen.childImageSharp.fluid} backgroundColor={`#040e18`}/>} title={"One Stop Properties"} description={"The place to find industrial or commercial properties in the greater NYC area. I worked on the site’s redesign. I aimed to create a more fully featured solution complete with a new theme and custom backend for easy property updates. It is built with wordpress and hosted on WPEngine."} link={"https://onestopspaces.com"} tags={"Wordpress, WP Engine"}/>
      <WorkItem img={<StyledBackgroundSection  Tag="div" className={className} fluid={data.paintingScreen.childImageSharp.fluid} backgroundColor={`#040e18`}/>} title={"Scroll Painting"} border description={"A digital showcase of watercolor paintings by Suvi Karjalainen. I worked closely with Suvi to design this site to be minimal yet dynamic. I developed the Frontend with bootstrap UI frameowrk. I originally built a barebones cms on the backend using PHP, the solution is now hosted on Netlify."} link={"https://scrollpainting.org"} tags={"Bootstrap, PHP, MediaTemple"}/>
      <WorkItem isReversed img={<StyledBackgroundSection  Tag="div" className={className} fluid={data.mediawikiScreen.childImageSharp.fluid} backgroundColor={`#040e18`}/>} project={"Development"} title={"Docket Engine Wiki"} description={"A Wikipedia of sorts for the intellectual property rulesets that power HeliosComplete. I worked with a backend developer to deliver the Frontend solution to the app, modifing a preexisting php wiki framework called MediaWiki. The backend is using PHP, its hosted on MediaTemple."} link={"https://www.ipdocketengine.com"} tags={"MediaWiki, MediaTemple"}/>
      <WorkItem img={<StyledBackgroundSection  Tag="div" className={className} fluid={data.tractionScreen.childImageSharp.fluid} backgroundColor={`#040e18`}/>} title={"Traction2Vision"} border  description={"Helping Business Leaders Get What They Want Out of Their Businesses. I built this site as a prototype for Dan Paxton, the CEO of Traction2Vision. He wanted to keep the design professional and to the point, aimed at small business owners. I developed the site using Bootstrap and Jekyll, as static site generator. It is hosted on Netlify."} link={"https://traction2vision.netlify.com"} tags={"Jekyll, Netlify"}/>
      <WorkItem isReversed img={<StyledBackgroundSection  Tag="div" className={className} fluid={data.terminalScreen.childImageSharp.fluid} backgroundColor={`#040e18`}/>} title={"Terminal Emulator"}  description={"A terminal ui that originally served as my portfolio site. You can resize, collapse, and drag n drop the frame as if it were a desktop interface. It utilizes and open source command line interpreter/ terminal emulator written in Javascript. Try writing bash commands to it!"} link={"https://jakeschroeder.github.io"} tags={"Vanilla, Github Pages"}/>
