...
const ProjectsPage = ({data, className}) => (
  <Fragment>
    <Seo title="Projects" />
      ...
      <WorkItem img={<StyledBackgroundSection  Tag="div" className={className} fluid={data.mediawikiScreen.childImageSharp.fluid} backgroundColor={`#040e18`}/>} project={"Development"} title={"Helios Docket Engine Wiki"} border description={"A Wikipedia of sorts for the intellectual property rulesets that power HeliosComplete. I worked with a backend developer to deliver the Frontend solution to the app, modifing a preexisting php wiki framework called MediaWiki. The backend is using PHP, its hosted on MediaTemple."} link={"https://www.ipdocketengine.com"} tags={"MediaWiki, MediaTemple"}/>
      <WorkItem isReversed img={<StyledBackgroundSection  Tag="div" className={className} fluid={data.tractionScreen.childImageSharp.fluid} backgroundColor={`#040e18`}/>} title={"Traction2Vision"} description={"Helping Business Leaders Get What They Want Out of Their Businesses. I built this site as a prototype for Dan Paxton, the CEO of Traction2Vision. He wanted to keep the design professional and to the point, aimed at small business owners. I developed the site using Bootstrap and Jekyll, as static site generator. It is hosted on Netlify."} link={"https://traction2vision.netlify.com"} tags={"Jekyll, Netlify"}/>
      <WorkItem img={<StyledBackgroundSection  Tag="div" className={className} fluid={data.terminalScreen.childImageSharp.fluid} backgroundColor={`#040e18`}/>} title={"Terminal Emulator"} border description={"A terminal ui that originally served as my portfolio site. You can resize, collapse, and drag n drop the frame as if it were a desktop interface. It utilizes and open source command line interpreter/ terminal emulator written in Javascript. Try writing bash commands to it!"} link={"https://jakeschroeder.github.io"} tags={"Vanilla, Github Pages"}/>
