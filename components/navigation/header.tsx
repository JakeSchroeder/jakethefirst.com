  ...
  return (
    ...
    >
      <HStack justifyContent="space-between" alignItems="center" w="100%" pt={{ base: "4", md: "10" }}>
        <HStack>
          {logo}
          <Heading as="h3" fontSize="lg" fontWeight="medium" _hover={{ textDecor: "underline" }}>
        ...
        <UnorderedList listStyleType="none" display={["none", "none", "flex"]} textAlign="left" p="0" m="0">
          <ListItem
            ...
            textColor={router.asPath === "/projects" ? "black" : "blackAlpha.700"}
          ...
          <ListItem
            ...
            fontWeight="normal"
            ml="8"
            textColor={router.asPath === "/contact" ? "black" : "blackAlpha.700"}
            textDecorationColor="blackAlpha.600"
            _hover={{ textDecor: "underline" }}
          >
